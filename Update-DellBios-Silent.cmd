...
%WinDir%\Sysnative\windowsPowershell\V1.0\PowerShell.exe -NoProfile -ExecutionPolicy Bypass -File "%~dp0Update-DellBios.ps1" -Silent

GOTO END

:Native
PowerShell.exe -NoProfile -ExecutionPolicy Bypass -File "%~dp0Update-DellBios.ps1" -Silent
